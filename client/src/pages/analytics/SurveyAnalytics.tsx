        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-4 mt-1">
              ...
              <span className="text-sm text-text-secondary">{analytics.questionCount} questions</span>
            </div>
          </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="stat-card">
                <span className="stat-card-label">Avg. Completion Time</span>
            ...
            {analytics.nps && (
              <div className="card-soft">
                <h3 className="text-lg font-medium text-text-primary mb-4">Net Promoter Score (NPS)</h3>
                <div className="flex items-center gap-8">
                  <div className="text-center">
                    <p className={`text-5xl font-bold ${getNPSColor(analytics.nps.score)}`}>{analytics.nps.score}</p>
                    <p className="text-sm text-text-secondary mt-1">NPS Score</p>
                  </div>
                  <div className="flex-1 space-y-2">
                    <div className="flex items-center gap-2">
                      <span className="w-20 text-sm text-text-secondary">Promoters</span>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="w-20 text-sm text-text-secondary">Passives</span>
                      <div className="flex-1 bg-background rounded-full h-4">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="w-20 text-sm text-text-secondary">Detractors</span>
                      <div className="flex-1 bg-background rounded-full h-4">
            ...
            {analytics.trend.length > 0 && (
              <div className="card-soft">
                <h3 className="text-lg font-medium text-text-primary mb-4">Response Trend</h3>
            ...
            <div className="card-soft">
              <h3 className="text-lg font-medium text-text-primary mb-4">Response Status</h3>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-red-50 rounded-soft">
                  ...
                  <p className="text-sm text-red-800">Abandoned</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {questionAnalytics?.questions.map((q, index) => (
              <div key={q.questionId} className="card-soft">
                <div className="mb-4">
                  <p className="text-sm text-text-secondary">Question {index + 1}</p>
                  <h4 className="text-lg font-medium text-text-primary">{q.questionText}</h4>
                  <p className="text-sm text-text-muted">{q.type.replace('_', ' ')} • {q.totalAnswers} answers</p>
                </div>
