...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex('template_questions').insert([
    ...
    },
    {
      ...
      options: JSON.stringify({ choices: ['Daily', 'Weekly', 'Monthly', 'Rarely', 'First time'] }),
      is_required: true,
      order_index: 1,
    },
    {
  ...
  await knex('template_questions').insert([
    ...
    },
    {
      ...
      options: JSON.stringify({ choices: ['Feature A', 'Feature B', 'Feature C', 'Feature D', 'Other'] }),
      is_required: true,
      order_index: 2,
    },
    {
  ...
  await knex('template_questions').insert([
    ...
    },
    {
      ...
      options: JSON.stringify({ choices: ['Definitely Yes', 'Probably Yes', 'Not Sure', 'Probably Not', 'Definitely Not'] }),
      is_required: true,
      order_index: 3,
    },
    {
